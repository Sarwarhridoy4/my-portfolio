...
const MyBanner = () => {
    ...
    <div class="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
        <div class="w-full lg:w-1/2">
            <div class="lg:max-w-lg">
                ...
                <span className='text-xl font-semibold tracking-wide text-gray-800 dark:text-white lg:text-xl'>A MERN stack Developer</span>
    ...
    <span class="mx-1">Dwonload Cover Letter</span>
</button>
            </div>
        </div>

        <div class="flex items-center justify-center w-full h-96 lg:w-1/2">
            <img class="object-cover w-full h-full mx-auto rounded-md lg:max-w-2xl" src="https://images.unsplash.com/photo-1543269664-7eef42226a21?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="glasses"/>
        </div>
    </div>
</section>
    );
